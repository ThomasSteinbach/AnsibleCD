...
echo 'thomass/ansibleci image or deploy the workspace to the server and mount the'
echo 'workspace directory to the thomass/ansibleci container. On the server you'
